  ...
  return (
    <>
      ...
      <div className="artwrap">
        ...
        {/* inline side panel (no pop-up) */}
        <aside className="artpanel">
          {!sel ? (
            <div className="artempty">Select a post on the left to read it.</div>
          ) : (
            <>
              <span className={`ast ast-${sel.status}`}>{STATUS_LABEL[sel.status]}</span>
              <h3 className="artptitle">{sel.hook}</h3>
              <div className="artpmeta">
              ...
              <div className="dblk-h" style={{ marginTop: 14 }}>Status</div>
              <div className="pstatusrow">
